...
export class AaveLendingPoolV2__getConfigurationResultValue0Struct extends ethereum.Tuple {
  get data(): BigInt {
    return this[0].toBigInt();
  }
}

export class AaveLendingPoolV2__getReserveDataResultValue0Struct extends ethereum.Tuple {
  get configuration(): AaveLendingPoolV2__getReserveDataResultValue0ConfigurationStruct {
    return changetype<
      AaveLendingPoolV2__getReserveDataResultValue0ConfigurationStruct
    >(this[0].toTuple());
  }
...
export class AaveLendingPoolV2__getReserveDataResultValue0ConfigurationStruct extends ethereum.Tuple {
  get data(): BigInt {
    return this[0].toBigInt();
  }
}

export class AaveLendingPoolV2__getUserAccountDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class AaveLendingPoolV2__getUserConfigurationResultValue0Struct extends ethereum.Tuple {
  get data(): BigInt {
    return this[0].toBigInt();
  }
}

export class AaveLendingPoolV2 extends ethereum.SmartContract {
  static bind(address: Address): AaveLendingPoolV2 {
    return new AaveLendingPoolV2("AaveLendingPoolV2", address);
  }
  ...
  getConfiguration(
    asset: Address
  ): AaveLendingPoolV2__getConfigurationResultValue0Struct {
    let result = super.call(
      "getConfiguration",
    ...
    return changetype<AaveLendingPoolV2__getConfigurationResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      changetype<AaveLendingPoolV2__getConfigurationResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getReserveData(
    asset: Address
  ): AaveLendingPoolV2__getReserveDataResultValue0Struct {
    let result = super.call(
      "getReserveData",
    ...
    return changetype<AaveLendingPoolV2__getReserveDataResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getReserveData(
    asset: Address
  ): ethereum.CallResult<AaveLendingPoolV2__getReserveDataResultValue0Struct> {
    let result = super.tryCall(
      "getReserveData",
      "getReserveData(address):(((uint256),uint128,uint128,uint128,uint128,uint128,uint40,address,address,address,address,uint8))",
      [ethereum.Value.fromAddress(asset)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<AaveLendingPoolV2__getReserveDataResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getUserAccountData(
    user: Address
  ): AaveLendingPoolV2__getUserAccountDataResult {
    let result = super.call(
      "getUserAccountData",
    ...
    return new AaveLendingPoolV2__getUserAccountDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getUserAccountData(
    user: Address
  ): ethereum.CallResult<AaveLendingPoolV2__getUserAccountDataResult> {
    let result = super.tryCall(
      "getUserAccountData",
      "getUserAccountData(address):(uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(user)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new AaveLendingPoolV2__getUserAccountDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getUserConfiguration(
    user: Address
  ): AaveLendingPoolV2__getUserConfigurationResultValue0Struct {
    let result = super.call(
      "getUserConfiguration",
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<AaveLendingPoolV2__getUserConfigurationResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
